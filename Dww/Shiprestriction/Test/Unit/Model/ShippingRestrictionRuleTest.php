...
use Dww\Shiprestriction\Model\Message\MessageBuilder;
use Dww\Shiprestriction\Model\ShippingRestrictionRule;
...
class ShippingRestrictionRuleTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetValidRules()
    {
        ...
        $rule1 = $this->createMock(\Dww\Shiprestriction\Model\Rule::class);
        $rule2 = $this->createMock(\Dww\Shiprestriction\Model\Rule::class);
        $productRegistry = $this->createPartialMock(\Dww\Shiprestriction\Model\ProductRegistry::class, []);
        $salesRuleValidator = $this->createPartialMock(
            \Dww\CommonRules\Model\Validator\SalesRule::class,
            ['validate']
        );
