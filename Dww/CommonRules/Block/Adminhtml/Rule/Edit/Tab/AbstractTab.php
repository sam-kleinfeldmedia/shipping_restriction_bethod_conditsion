...
namespace Dww\CommonRules\Block\Adminhtml\Rule\Edit\Tab;
...
{
    /**
     * @var \Dww\CommonRules\Model\OptionProvider\Pool
     */
     ...
     * @param \Dww\CommonRules\Model\OptionProvider\Pool $poolOptionProvider
     * @param array $data
     */
    public function __construct(
        ...
        \Dww\CommonRules\Model\OptionProvider\Pool $poolOptionProvider,
        array $data = []
    ) {
