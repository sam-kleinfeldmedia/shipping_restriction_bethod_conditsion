...
use Dww\CommonRules\Model\RegistryConstants;
use Dww\CommonRules\Model\Rule\Condition\ConditionBuilder as Conditions;
use Dww\CommonRules\Model\Rule\Factory\HandleFactoryInterface;
...
class Combine extends \Magento\SalesRule\Model\Rule\Condition\Combine
{
     ...
     * @var string
     */
    protected $conditionsAddressPath = Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS .'Address';

    /**
     * @var \Dww\CommonRules\Model\Rule\Factory\HandleFactory
     */
    ...
    /**
     * @var \Dww\CommonRules\Model\Rule\Factory\CombineHandleFactory
     */
    ...
    public function __construct(
        ...
        \Dww\CommonRules\Model\Rule\Condition\Address $conditionAddress,
        ...
        $this->setType(Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS . 'Combine');
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive(
            ...
            [
                ...
                [
                    'value' => Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS . 'Product\Subselect',
