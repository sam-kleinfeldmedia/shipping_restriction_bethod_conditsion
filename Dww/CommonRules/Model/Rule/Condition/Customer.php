...
{
    const DWW_CUSTOMER_ATTRIBUTES_KEY_NAME = 'custom_attributes';
    ...
    public function validate(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if (!$customer instanceof \Magento\Customer\Model\Customer) {
            ...
            if (!isset($customerData[$attr])) {
                if (isset($customerData[self::DWW_CUSTOMER_ATTRIBUTES_KEY_NAME])) {
                    return $this->validateCustomerAttributes(
                        $attr,
                        $customerData[self::DWW_CUSTOMER_ATTRIBUTES_KEY_NAME]
                    );
                }
