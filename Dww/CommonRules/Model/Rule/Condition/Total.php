...
class Total extends \Magento\SalesRule\Model\Rule\Condition\Product\Combine
{
    ...
    /**
     * @var \Dww\CommonRules\Model\Calculator
     */
    private $calculator;
    ...
    public function __construct(
        ...
        \Dww\CommonRules\Model\Calculator $calculator,
        array $data = []
    ) {
        parent::__construct($context, $ruleConditionProduct, $data);
        $this->calculator = $calculator;
        $this->setType(Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS . 'Total')->setValue(null);
    }
    ...
    public function getNewChildSelectOptions()
    {
        $conditions = [
            ...
            [
                ...
                'value' => Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS . 'Total\Status'
            ],
            [
                'label' => __('Period after order was placed'),
                'value' => Conditions::dWW_COMMON_RULES_PATH_TO_CONDITIONS . 'Total\Period'
            ],
        ];
