...
namespace Dww\CommonRules\Model;
...
class Rule extends \Magento\Rule\Model\AbstractModel
{
    ...
    /**
     * @var \Dww\CommonRules\Model\Modifiers\Subtotal
     */
    ...
    public function __construct(
        ...
        \Dww\CommonRules\Model\Rule\Condition\Combine $conditionCombine,
        \Dww\CommonRules\Model\Rule\Condition\Product\Combine $conditionProductCombine,
        \Dww\CommonRules\Model\Modifiers\Subtotal $subtotalModifier,
        \Dww\CommonRules\Model\Validator\Backorder $backorderValidator,
        $resource = null,
        array $data = []
    ) {
