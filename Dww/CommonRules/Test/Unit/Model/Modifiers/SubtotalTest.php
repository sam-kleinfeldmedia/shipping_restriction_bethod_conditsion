...
namespace Dww\CommonRules\Test\Unit\Model\Modifiers;

use Dww\CommonRules\Model\Modifiers\Subtotal;
...
class SubtotalTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testModify($tax, $discount, $expectedSubtotal, $expectedBaseSubtotal)
    {
        ...
        $config = $this->createMock(\Dww\CommonRules\Model\Config::class);
